...
import { acceptPayroll, getAllPayrolls, getPayrollRates, payPayroll, rejectPayroll, unwrapApiData, updatePayrollRates } from '../../../api/axios';
...
export default function PembayaranPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const [payrollResponse, rateResponse] = await Promise.all([
